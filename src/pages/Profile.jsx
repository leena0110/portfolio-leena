        ...
        <>
            ...
            <section className="section">
                <div className="container">
                    ...
                    <div className="bio-section" style={{ display: 'flex', justifyContent: 'center', marginBottom: 'var(--space-2xl)' }}>
                        <div className="bio-card" style={{ maxWidth: '800px', width: '100%' }}>
                            <h3><i className="fas fa-briefcase"></i> Experience</h3>
                            <div className="bio-text">
                                <h4 style={{ color: 'var(--text-primary)', marginBottom: '8px', fontSize: '1.2rem', fontWeight: '600' }}>Full Stack Developer Intern</h4>
                                <p style={{ color: 'var(--secondary-color)', fontWeight: '600', marginBottom: '16px', fontSize: '1rem' }}>SMI Techsolutions Pvt. Ltd. • May 2026</p>
                                <p>Worked on user registration workflows, backend API integration, responsive UI improvements, frontend validation handling, and schema management for a full-stack web application.</p>
                                <p style={{ marginTop: '16px' }}><strong>Tech Stack:</strong> <span style={{ color: 'var(--text-secondary)' }}>React.js • NestJS • PostgreSQL • Prisma ORM • Docker</span></p>
                                <div style={{ marginTop: '24px' }}>
                                    <a href="https://drive.google.com/file/d/1sLDPQEJhf8LK0LXt1f8E_4w3qh-wblCC/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="btn btn-secondary" style={{ width: 'fit-content', padding: '10px 24px', fontSize: '0.95rem' }}>
